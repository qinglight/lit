...
### 更新说明（2016.09.16）
1. 精简代码结构，提高代码执行效率（80%的代码进行了重构）
2. 减小工程依赖，剔除了60%的依赖包，核心功能最小实现
3. 提供插件体系，通过新增指令plugin可以安装插件，现阶段提供三个插件es6/jade/less
4. 程序执行异常的时候增加进程退出标志，错误码255
5. 修复一直以来的最大缺陷对换行符不再敏感，多平台兼容支持
6. 增加lighting开发框架1.0的支持，可以辅助light1.0框架的开发
